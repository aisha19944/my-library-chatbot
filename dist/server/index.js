    ...
    try {
        const response = await axios.post('https://openrouter.ai/api/v1/chat/completions', {
            ...
            messages: [
                {
                    role: 'system',
                    content: 'You are a smart academic assistant for students of Usmanu Danfodiyo University, Sokoto. Answer clearly, help with school questions, and provide helpful academic support.',
                },
                ...conversationHistory,
            ],
        }, {
